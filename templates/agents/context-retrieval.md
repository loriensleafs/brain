...
Brain memory bootstrap(url="analysis/topic-name", depth=2)

# Browse folder structure
Brain memory list(dir_name="analysis")
```
...
1. Query Brain: `Brain memory search`
2. Find relevant notes (e.g., OAuth implementation, architecture patterns)
3. Build context: `Brain memory bootstrap(url="analysis/oauth-patterns", depth=2)`

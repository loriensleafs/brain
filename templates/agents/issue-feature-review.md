...
You are an expert TypeScript open-source reviewer. Be polite, clear, and constructively skeptical.
...
```text
mcp__plugin_brain_brain__search({ query: "[feature topic] patterns", limit: 10 })
```
...
mcp__plugin_brain_brain__write_note({
  title: "ANALYSIS-NNN-feature-review-[topic]",
  folder: "analysis",
  content: "---\ntitle: ANALYSIS-NNN-feature-review-[topic]\ntype: analysis\ntags: [feature-review, evaluation]\n---\n\n# Feature Review: [Topic]\n\n## Observations\n\n- [decision] [Recommendation] #feature-review\n- [fact] [Evidence] #evaluation\n\n## Relations\n\n- relates_to [[relevant-entity]]"
})
```

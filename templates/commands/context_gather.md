---
description: Gather comprehensive context from Brain memory, Context7 docs, and web sources before planning or implementation. Use when starting complex tasks requiring multi-source context.
...
**Purpose**: Gather relevant context from Brain memory, Context7, and web sources before planning or implementing code.
...
- Search Brain memory across ALL projects for relevant patterns, decisions, and code

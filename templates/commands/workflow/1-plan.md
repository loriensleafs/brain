...
Maps to Agent Orchestration MCP (ADR-013): `get_routing_recommendation()`, `invoke_agent()`, `track_handoff()`. Fallback: direct `Agent()` invocation with appropriate `subagent_type`.

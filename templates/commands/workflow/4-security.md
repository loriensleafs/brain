...
Maps to Agent Orchestration MCP (ADR-013): `invoke_agent("security", ...)`, `track_handoff()`. When an issue has a `security` label, this step cannot be skipped. Fallback: `Agent(subagent_type="security", prompt=...)`.

...
bun run .claude/skills/merge-resolver/scripts/resolve_pr_conflicts.ts \
...
| `bun.lock` | Lock files; regenerate from main |
...
bun run scripts/validate_session_json.ts "$SESSION_LOG"
```

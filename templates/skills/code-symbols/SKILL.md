...
4. **Combine with Brain memory** - create Brain memory notes for important architectural findings
...
Use [code-architecture](../code-architecture/SKILL.md) instead when:

- Performing full architectural analysis with memory persistence
- Building knowledge graphs from code structure

...
1. Run `bun run .claude/skills/taste-lints/scripts/taste_lints.ts` with target files
...
```bash
# Scan staged files
bun run .claude/skills/taste-lints/scripts/taste_lints.ts --git-staged

# Scan specific files
bun run .claude/skills/taste-lints/scripts/taste_lints.ts path/to/file.py

# Scan a directory
bun run .claude/skills/taste-lints/scripts/taste_lints.ts --directory src/

# JSON output
bun run .claude/skills/taste-lints/scripts/taste_lints.ts --format json --git-staged

# Run specific rules only
bun run .claude/skills/taste-lints/scripts/taste_lints.ts --rules file-size,naming
```

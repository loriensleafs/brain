...
bun run .claude/skills/analysis-provenance/scripts/check_provenance.ts --target .config/markdownlint.json

# Check provenance of a directory
bun run .claude/skills/analysis-provenance/scripts/check_provenance.ts --target .config/

# JSON output for automation
bun run .claude/skills/analysis-provenance/scripts/check_provenance.ts --target PSScriptAnalyzerSettings.psd1 --format json
```
...
│
├─ Run: bun run .claude/skills/analysis-provenance/scripts/check_provenance.ts --target <file>
│
├─ Result: UPSTREAM
...
```bash
bun run .claude/skills/analysis-provenance/scripts/check_provenance.ts --target <path> [options]
```
...
```bash
bun run .claude/skills/analysis-provenance/scripts/check_provenance.ts --target .markdownlint.json
```
...
```bash
bun run .claude/skills/analysis-provenance/scripts/check_provenance.ts --target node_modules/markdownlint-cli2/lib/main.js
```
...
bun run .claude/skills/analysis-provenance/scripts/check_provenance.ts \
...
- id: provenance-check
  ...
  entry: bun run .claude/skills/analysis-provenance/scripts/check_provenance.ts

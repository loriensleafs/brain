...
|----------------|-----------|
| `collect agent metrics` | Run collect_metrics.ts with default 30-day window |
...
|--------|----------|-------|
| `scripts/collect_metrics.ts` | Bun | Cross-platform |

## Quick Start

```bash
# Basic usage (30 days, summary output)
bun run .claude/skills/metrics/scripts/collect_metrics.ts

# Last 90 days as markdown
bun run .claude/skills/metrics/scripts/collect_metrics.ts --since 90 --output markdown

# JSON output for automation
bun run .claude/skills/metrics/scripts/collect_metrics.ts --output json
```

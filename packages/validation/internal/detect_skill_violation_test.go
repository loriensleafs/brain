...
func TestGhCommandPatterns_PRCommands(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			matched := false
			for _, pattern := range internal.GhCommandPatterns {
...
`,
	...
	result := internal.DetectSkillViolationsFromContent(contents)
...
`
	...
	violations, err := internal.ScanFileForViolations(testFile)
	if err != nil {
...
func TestScanFileForViolations_NonexistentFile(t *testing.T) {
	_, err := internal.ScanFileForViolations("/nonexistent/path/file.md")
	if err == nil {
...
func TestSkillViolationResult_HasSkillViolations(t *testing.T) {
	...
	resultWithViolations := internal.SkillViolationResult{
		Violations: []internal.SkillViolation{
	...
	resultNoViolations := internal.SkillViolationResult{}
...
func TestSkillViolationResult_ViolationCount(t *testing.T) {
	result := internal.SkillViolationResult{
		Violations: []internal.SkillViolation{
			{File: "a.md", Line: 1},
			{File: "b.md", Line: 2},
			{File: "c.md", Line: 3},
...
func TestDetectSkillViolations_NoSkillsDir(t *testing.T) {
	...
	result := internal.DetectSkillViolations(tmpDir, false)

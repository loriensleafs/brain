...
func TestDetectTestCoverageGaps_GoFiles(t *testing.T) {
	...
	result := internal.DetectTestCoverageGaps(internal.TestCoverageGapOptions{
		BasePath: tmpDir,
		Language: "go",
	})
...
func TestDetectTestCoverageGapsForLanguage(t *testing.T) {
	...
	result := internal.DetectTestCoverageGapsForLanguage(tmpDir, "go", 0)
...
func TestDetectTestCoverageGapsStaged(t *testing.T) {
	...
	result := internal.DetectTestCoverageGapsStaged(tmpDir, "go")
...
func TestGetSupportedLanguages(t *testing.T) {
	languages := internal.GetSupportedLanguages()
...
func TestAddLanguageConfig(t *testing.T) {
	...
	internal.AddLanguageConfig("rust", internal.LanguageConfig{
		Extensions:  []string{".rs"},
		TestSuffix:  "_test.rs",
		TestPattern: internal.LanguageConfigs["go"].TestPattern, // Reuse pattern for testing
	...
	// Clean up
	delete(internal.LanguageConfigs, "rust")
}

...
func TestGetRepoRoot_Success(t *testing.T) {
	...
	root, err := validation.GetRepoRoot(mock)
...
func TestGetRepoRoot_NotARepo(t *testing.T) {
	...
	_, err := validation.GetRepoRoot(mock)
...
func TestGetPRBranch_Success(t *testing.T) {
	...
	branch, err := validation.GetPRBranch(123, mock)
...
func TestGetPRBranch_PRNotFound(t *testing.T) {
	...
	_, err := validation.GetPRBranch(999, mock)
...
func TestGetPRBranch_InvalidJSON(t *testing.T) {
	...
	_, err := validation.GetPRBranch(123, mock)
...
func TestCreatePRWorktree_Success(t *testing.T) {
	...
	result := validation.CreatePRWorktree(123, tmpDir, mock)
...
func TestCreatePRWorktree_PRNotFound(t *testing.T) {
	...
	result := validation.CreatePRWorktree(999, tmpDir, mock)
...
func TestGetWorktreeStatus_NotExists(t *testing.T) {
	...
	status := validation.GetWorktreeStatus(123, tmpDir, mock)
...
func TestPushWorktreeChanges_NotExists(t *testing.T) {
	...
	result := validation.PushWorktreeChanges(123, tmpDir, mock)
...
func TestRemovePRWorktree_NotExists(t *testing.T) {
	...
	result := validation.RemovePRWorktree(123, tmpDir, false, mock)
...
func TestRemovePRWorktree_DirtyWithForce(t *testing.T) {
	...
	result := validation.RemovePRWorktree(123, tmpDir, true, mock)
...
func TestRunBatchPRReview_Setup(t *testing.T) {
	...
	config := validation.BatchPRReviewConfig{
		PRNumbers:    []int{123, 456},
		Operation:    validation.OperationSetup,
		WorktreeRoot: tmpDir,
	}

	result := validation.RunBatchPRReviewWithRunner(config, mock)

	if !result.Valid {
		t.Errorf("Expected valid result, got: %s", result.Message)
	}
	if result.Operation != validation.OperationSetup {
...
func TestRunBatchPRReview_Status(t *testing.T) {
	...
	config := validation.BatchPRReviewConfig{
		PRNumbers:    []int{123, 456},
		Operation:    validation.OperationStatus,
		WorktreeRoot: tmpDir,
	}
...
func TestRunBatchPRReview_Cleanup(t *testing.T) {
	...
	config := validation.BatchPRReviewConfig{
		PRNumbers:    []int{123},
		Operation:    validation.OperationCleanup,
		WorktreeRoot: tmpDir,
		Force:        false,
	}
...
func TestRunBatchPRReview_All(t *testing.T) {
	...
	config := validation.BatchPRReviewConfig{
		PRNumbers:    []int{123},
		Operation:    validation.OperationAll,
		WorktreeRoot: tmpDir,
	}
...
func TestOperationConstants(t *testing.T) {
	if validation.OperationSetup != "Setup" {
		t.Errorf("Expected OperationSetup='Setup', got: %s", validation.OperationSetup)
	}
	if validation.OperationStatus != "Status" {
		t.Errorf("Expected OperationStatus='Status', got: %s", validation.OperationStatus)
	}
	if validation.OperationCleanup != "Cleanup" {
		t.Errorf("Expected OperationCleanup='Cleanup', got: %s", validation.OperationCleanup)
	}
	if validation.OperationAll != "All" {
		t.Errorf("Expected OperationAll='All', got: %s", validation.OperationAll)
	}
}

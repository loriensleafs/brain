...
`
	...
	result := validation.ValidateMemoryIndex(tmpDir)
...
func TestValidateMemoryIndex_PathNotFound(t *testing.T) {
	result := validation.ValidateMemoryIndex("/nonexistent/path")
...
`,
	...
	result := validation.ValidateMemoryIndexFromContent(indexContents, "")

...
func TestCheckBrainInitialization(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := validation.CheckBrainInitialization(tt.content)
...
func TestCheckBrainUpdate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := validation.CheckBrainUpdate(tt.content)
			if result != tt.expected {
...
func TestCheckBranchDocumented(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := validation.CheckBranchDocumented(tt.content)
			if result != tt.expected {
...
func TestCheckCommitEvidence(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := validation.CheckCommitEvidence(tt.content)
			if result != tt.expected {
...
func TestCheckLintEvidence(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := validation.CheckLintEvidence(tt.content)
			if result != tt.expected {
...
`
	...
	result := validation.ValidateChecklist(content, "Session Start")
...
`
	...
	startSection := validation.ExtractSection(content, "Session Start")
	if startSection == "" {
	...
	endSection := validation.ExtractSection(content, "Session End")
	if endSection == "" {
...
func TestTruncateString(t *testing.T) {
	...
	for _, tt := range tests {
		result := validation.TruncateString(tt.input, tt.maxLen)
		if result != tt.expected {
...
func TestValidateSessionProtocol_FileNotFound(t *testing.T) {
	result := validation.ValidateSessionProtocol("/nonexistent/path/2024-01-01-session-01.md")
...
`
	...
	result := validation.ValidateSessionProtocol(invalidPath)

	// Find filename_format check
	var filenameCheck *validation.Check
...
`
	...
	result := validation.ValidateSessionProtocol(validPath)
...
`
	...
	result := validation.ValidateSessionProtocolFromContent(content, "2024-01-01-session-01.md")

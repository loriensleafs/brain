...
func TestValidatePrePR_EmptyDirectory(t *testing.T) {
	...
	result := validation.ValidatePrePR(tmpDir, false)
...
func TestValidatePrePR_QuickMode(t *testing.T) {
	...
	result := validation.ValidatePrePR(tmpDir, true)
...
`
	...
	config := validation.DefaultPrePRConfig(tmpDir)
	result := validation.ValidateCrossCuttingConcerns(config)
...
`
	...
	config := validation.DefaultPrePRConfig(tmpDir)
	result := validation.ValidateFailSafeDesign(config)
...
func TestValidateTestImplementationAlignment_NoSourceFiles(t *testing.T) {
	...
	config := validation.DefaultPrePRConfig(tmpDir)
	result := validation.ValidateTestImplementationAlignment(config)
...
func TestValidateCIEnvironment_NoConfig(t *testing.T) {
	...
	config := validation.DefaultPrePRConfig(tmpDir)
	result := validation.ValidateCIEnvironment(config)
...
func TestValidateEnvironmentVariables_NoEnvFile(t *testing.T) {
	...
	config := validation.DefaultPrePRConfig(tmpDir)
	result := validation.ValidateEnvironmentVariables(config)
...
`,
	...
	result := validation.ValidatePrePRFromContent(content, false)
...
`,
	...
	result := validation.ValidatePrePRFromContent(content, true)
...
`
	...
	result := validation.ValidatePrePRWithConfig(config)
...
func TestDefaultPrePRConfig(t *testing.T) {
	config := validation.DefaultPrePRConfig("/test/path")
...
`
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		validation.ValidatePrePR(tmpDir, false)
	}
}
...
func BenchmarkValidatePrePRFromContent(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		validation.ValidatePrePRFromContent(content, false)
	}
}

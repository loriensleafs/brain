...
`
	...
	result := validation.CheckSkillExists(tmpDir, "test-skill")
...
func TestCheckSkillExists_SkillNotFound(t *testing.T) {
	...
	result := validation.CheckSkillExists(tmpDir, "nonexistent-skill")
...
func TestCheckSkillExists_EmptySkillName(t *testing.T) {
	...
	result := validation.CheckSkillExists(tmpDir, "")
...
`
	...
	result := validation.CheckSkillExists(tmpDir, "no-frontmatter")
	...
	var frontmatterCheck *validation.Check
...
`
	...
	result := validation.CheckSkillExists(tmpDir, "missing-name")
	...
	var nameCheck *validation.Check
	for i := range result.Checks {
...
`
	...
	result := validation.CheckSkillExists(tmpDir, "missing-desc")
	...
	var descCheck *validation.Check
	for i := range result.Checks {
...
`,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := validation.CheckSkillExists(tmpDir, tt.name)
...
`
	...
	result := validation.CheckSkillExists(tmpDir, "unclosed")
...
`
	...
	result, err := validation.ListSkills(tmpDir)
	if err != nil {
...
`
	...
	results, err := validation.ValidateAllSkills(tmpDir)
	if err != nil {
...
func TestCheckSkillScript_Found(t *testing.T) {
	...
	found, path := validation.CheckSkillScript(tmpDir, "pr", "PRContext")
...
func TestCheckSkillScript_NotFound(t *testing.T) {
	...
	found, path := validation.CheckSkillScript(tmpDir, "pr", "Nonexistent")
...
func TestCheckSkillScript_InvalidOperation(t *testing.T) {
	...
	found, _ := validation.CheckSkillScript(tmpDir, "invalid", "action")
...
func TestCheckSkillScript_EmptyAction(t *testing.T) {
	...
	found, _ := validation.CheckSkillScript(tmpDir, "pr", "")
...
func TestCheckSkillScript_CaseInsensitive(t *testing.T) {
	...
	found, _ := validation.CheckSkillScript(tmpDir, "issue", "issuedetails")
...
func TestCheckSkillScript_AllOperations(t *testing.T) {
	...
	for _, op := range operations {
		t.Run(op, func(t *testing.T) {
			...
			found, _ := validation.CheckSkillScript(tmpDir, op, "Action")
...
func TestListSkillScripts(t *testing.T) {
	...
	result, err := validation.ListSkillScripts(tmpDir, "pr")
	if err != nil {
...
func TestListAllSkillScripts(t *testing.T) {
	...
	result, err := validation.ListAllSkillScripts(tmpDir)
	if err != nil {
...
`
	...
	result := validation.CheckSkillExists(tmpDir, "path-test")
...
func TestCheckSkillExists_SkillPathOnNotFound(t *testing.T) {
	...
	result := validation.CheckSkillExists(tmpDir, "missing")

...
`
	result := validation.ValidateSkillFormatFromContent(content, "pr-001-review-helper.md")
...
`
	result := validation.ValidateSkillFormatFromContent(content, "pr-001-review.md")
...
# Content
`
	result := validation.ValidateSkillFormatFromContent(content, "pr-001-test.md")
...
# Content
`
	result := validation.ValidateSkillFormatFromContent(content, "skill-test.md")
...
`
	...
	for _, name := range validNames {
		t.Run(name, func(t *testing.T) {
			result := validation.ValidateSkillFormatFromContent(content, name)
...
`
	result := validation.ValidateSkillFormatFromContent(content, "pr-001-bundled.md")
...
`
	result := validation.ValidateSkillFormatFromContent(content, "pr-001-single.md")
...
`,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := validation.ValidateSkillFormatFromContent(tt.content, "pr-001-test.md")
...
func TestValidateSkillFormat_FileNotFound(t *testing.T) {
	result := validation.ValidateSkillFormat("/nonexistent/path/skill.md")
...
`
	...
	result := validation.ValidateSkillFormat(filePath)
...
func TestValidateSkillDirectory_EmptyDir(t *testing.T) {
	...
	results := validation.ValidateSkillDirectory(tmpDir)
...
func TestValidateSkillDirectory_NonexistentDir(t *testing.T) {
	results := validation.ValidateSkillDirectory("/nonexistent/path")
...
func TestValidateSkillFiles_EmptyList(t *testing.T) {
	results := validation.ValidateSkillFiles([]string{})
...
`
	...
	results := validation.ValidateSkillFiles(filePaths)
...
func TestValidateSkillFiles_SkipsIndexFiles(t *testing.T) {
	...
	results := validation.ValidateSkillFiles(indexPaths)
...
`
	result := validation.ValidateSkillFormatFromContent(content, "skill-bad.md")
...
func TestValidateSkillFormatFromContent_EmptyContent(t *testing.T) {
	result := validation.ValidateSkillFormatFromContent("", "pr-001-empty.md")
...
`
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		validation.ValidateSkillFormatFromContent(content, "pr-001-benchmark.md")
	}
}
...
`
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		validation.ValidateSkillDirectory(tmpDir)
	}
}

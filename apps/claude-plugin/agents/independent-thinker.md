...
- **Brain MCP memory tools**: Historical context (`mcp__plugin_brain_brain__search`, `mcp__plugin_brain_brain__read_note`)
...
```python
mcp__plugin_brain_brain__search(query="analysis challenges [topic/assumption]")
```
...
```python
mcp__plugin_brain_brain__edit_note(
    identifier="analysis/challenge-[topic]",
    operation="append",
    content="- [insight] [Analytical findings and challenged assumptions] #challenge"
)
```

...
memory: ~/.agents/agent-memory/task-generator
color: "#FFA07A"
...
- **Brain MCP memory tools**: Task breakdown patterns (`mcp__plugin_brain_brain__search`, `mcp__plugin_brain_brain__read_note`)

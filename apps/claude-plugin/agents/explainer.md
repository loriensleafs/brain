...
memory: ~/.agents/agent-memory/explainer
color: "#00CED1"
...
- **Brain MCP memory tools**: Store feature context (`mcp__plugin_brain_brain__search`, `mcp__plugin_brain_brain__write_note`)
...
content: "[Feature definition and context]"
```

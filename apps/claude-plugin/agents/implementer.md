...
- **Brain MCP memory tools**: Implementation patterns (`mcp__plugin_brain_brain__search`, `mcp__plugin_brain_brain__read_note`)
...
```python
mcp__plugin_brain_brain__search(query="implementation patterns [component/feature]")
```
...
mcp__plugin_brain_brain__edit_note(
    identifier="patterns/implementation-[topic]",
    operation="append",
    content="- [technique] [Implementation notes and patterns discovered] #implementation"
)
```

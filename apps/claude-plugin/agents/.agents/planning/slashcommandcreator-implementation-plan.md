...
allowed-tools: [WebSearch, WebFetch, mcp__plugin_brain_brain__*, mcp__plugin_brain_brain__*]
model: opus
---
...
3. **Security Validation**
   ...
   - Allowed wildcards: `mcp__*`, `mcp__plugin_brain_brain__*`, `mcp__plugin_brain_brain__*` (scoped namespaces)
...
allowed-tools: [mcp__plugin_brain_brain__*]
---
Execute: !mcp__plugin_brain_brain__search
"@ | Out-File $file
...
+allowed-tools: [mcp__plugin_brain_brain__*, mcp__context7__*, WebSearch, WebFetch]
+model: opus
+---
+
...
allowed-tools: [Bash, mcp__plugin_brain_brain__*]

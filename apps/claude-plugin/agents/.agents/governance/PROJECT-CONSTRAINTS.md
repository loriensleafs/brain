...
**Reference**: Use `mcp__plugin_brain_brain__read_note` with `memory_file_name="usage-mandatory"`
...
**Reference**: Use `mcp__plugin_brain_brain__read_note` with `memory_file_name="code-style-conventions"`

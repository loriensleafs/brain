...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Project ai-agents activated |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Manual confirmed |

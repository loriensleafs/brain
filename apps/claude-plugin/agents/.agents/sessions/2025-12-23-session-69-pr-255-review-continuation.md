...
|-------|-------------|--------|----------|
| **Phase 1** | `mcp__plugin_brain_brain__build_context` | ✅ | Onboarding confirmed |
| **Phase 1** | `mcp__plugin_brain_brain__build_context` | ⏭️ | Skipped (pr-comment-responder has own instructions) |

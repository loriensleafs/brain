...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Invoked with project='ai-agents' at session start |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Manual read confirmed |

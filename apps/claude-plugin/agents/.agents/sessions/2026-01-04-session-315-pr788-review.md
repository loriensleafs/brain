...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Project 'ai-agents' at /home/richard/ai-agents is activated |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Tool output present, Serena instructions manual loaded |

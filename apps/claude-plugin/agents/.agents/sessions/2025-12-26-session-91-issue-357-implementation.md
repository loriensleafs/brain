...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Project activated at session start |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Instructions already read |

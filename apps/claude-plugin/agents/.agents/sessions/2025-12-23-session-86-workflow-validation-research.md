...
|:---:|:-----|:------:|:---------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Project activated via parent orchestrator |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Instructions loaded |

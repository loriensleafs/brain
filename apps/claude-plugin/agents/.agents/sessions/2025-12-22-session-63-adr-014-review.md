...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Tool not available (activate_project), used initial_instructions |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Tool output present - project activated |

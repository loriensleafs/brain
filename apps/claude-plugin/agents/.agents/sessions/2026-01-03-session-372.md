...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Context continuation from 366 |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Context continuation |

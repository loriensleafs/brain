...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Serena onboarding confirmed |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Via check_onboarding_performed |

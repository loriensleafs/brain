...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [ ] | Serena MCP tools unavailable (`list_mcp_resources` returned none) |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [ ] | Serena MCP tools unavailable |

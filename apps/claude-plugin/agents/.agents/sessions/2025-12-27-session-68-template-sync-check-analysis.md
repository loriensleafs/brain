...
| | `mcp__plugin_brain_brain__build_context` | [x] | Error: No such tool (using native tools instead) |
| | `mcp__plugin_brain_brain__build_context` | [x] | Loaded Serena instructions manual |

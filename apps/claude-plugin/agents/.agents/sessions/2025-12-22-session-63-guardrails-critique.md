...
|-------|-------------|--------|----------|
| 1 | `mcp__plugin_brain_brain__build_context` | ✅ PASS | Tool output: project activated |
| 1 | `mcp__plugin_brain_brain__build_context` | ✅ PASS | Tool output: instructions received |

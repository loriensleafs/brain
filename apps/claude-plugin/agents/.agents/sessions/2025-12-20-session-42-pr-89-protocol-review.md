...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Tool output present (project path D:\src\GitHub\rjmurillo-bot\ai-agents recognized) |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Tool output present (Serena instructions manual loaded, project memories available) |
...
|------|----------|-------------------|----------|----------|---------|
| **Phase 1**: Serena Init `mcp__plugin_brain_brain__build_context` | ✓ MUST | ⚠️ NOT AVAILABLE | Session 01 line 30: "tool not available" | **MUST** | ❌ VIOLATION |
| **Phase 1**: Serena Init `mcp__plugin_brain_brain__build_context` | ✓ MUST | ✅ COMPLETE | Session 01 line 31: "COMPLETE" | **MUST** | ✅ OK |
...
2. **Phase 1 - Partial Failure**
   - `mcp__plugin_brain_brain__build_context` not available

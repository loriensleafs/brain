...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Tool output: Project activated (implicit) |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Tool output: Complete Serena instructions loaded |

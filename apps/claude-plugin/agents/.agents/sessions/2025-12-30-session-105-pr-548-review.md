...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Project activated in continued session context |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Instructions read in continued session context |

...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | `check_onboarding_performed` output in transcript |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Already have manual in context (skipped) |

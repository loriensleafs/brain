...
|-----|------|--------|----------|
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Inherited from parent orchestrator (Session 62) |
| MUST | Initialize Serena: `mcp__plugin_brain_brain__build_context` | [x] | Inherited from parent orchestrator |
...
| SHOULD | Search relevant Serena memories | [x] | devops-validation-runner-pattern |

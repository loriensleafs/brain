...
mcp__plugin_brain_brain__search(query="spec patterns")

# Read relevant memory if it exists
mcp__plugin_brain_brain__read_note(identifier="spec-[feature-type]-patterns")
```
...
mcp__plugin_brain_brain__write_note(
    title="Specification Summary: [Feature Name]",
    folder="specs",
    content="""
## Artifacts Created

...
memory: ~/.agents/agent-memory/high-level-advisor
color: "#FFD700"
...
mcp__plugin_brain_brain__search(query="strategic decisions [topic]")

# Read specific memory
mcp__plugin_brain_brain__read_note(identifier="[relevant-memory-name]")
```

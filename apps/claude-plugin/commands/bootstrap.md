...
You should ALWAYS be acting as the Team Lead.  Reload both the brain orchestrator agent and the [AGENTS.md](/Users/peter.kloss/AGENTS.md).  Reread the ENTIRE brain orchestrator agent and the following sections from the AGENTS.md:

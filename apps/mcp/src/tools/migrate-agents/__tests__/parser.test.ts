...
describe('getTargetFolder', () => {
  ...
  it('maps specs/requirements', () => {
    expect(getTargetFolder('requirement', 'specs/requirements')).toBe('specs/requirements');
  });

  it('handles nested paths', () => {
    expect(getTargetFolder('requirement', 'specs/requirements/auth')).toBe('specs/requirements');
  });

 ...
 */
function createTestBrainConfig(config: BrainConfig): void {
 ...
 */
function readTestBrainConfig(): BrainConfig {
  const configPath = path.join(TEST_CONFIG_DIR, "config.json");
 ...
 */
function readTestBasicMemoryConfig(): Record<string, unknown> {
 ...
 */
function createTestMemoryFiles(dir: string, count: number): void {

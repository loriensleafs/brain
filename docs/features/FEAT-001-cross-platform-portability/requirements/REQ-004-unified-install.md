...
- [x] [requirement] AC-03: Cursor installed via file copy to .cursor/ with 🧠-prefixed filenames #cursor
...
- [x] [requirement] AC-07: Cursor hooks and MCP config use JSON merge (not overwrite) with manifest tracking #json-merge
